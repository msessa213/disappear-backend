...
class DBProfile(Base):
    ...
    notice_acknowledged = Column(Boolean, default=False)
    dnc_registered = Column(Boolean, default=False)
    dnc_registered_at = Column(DateTime, nullable=True)
    dnc_state_registered = Column(Boolean, default=False)
    dnc_optout_prescreen = Column(Boolean, default=False)
    dnc_dmachoice = Column(Boolean, default=False)
