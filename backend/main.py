...
BROKERS = [
    ...
    "AUDIENS_DATA", "AUTOMATED_INFO",
    "BACKGROUNDALERT", "BACKGROUNDCHECK_PLUS", "BACKGROUND_CHECKER", "BACKGROUND_CHECK_ONLINE",
    ...
    "DISCOVER_ORGANIZATION", "DNB_BUSINESS",
    ...
    "FAST_BACKGROUND_CHECK",
    "FINANCIAL_DATA_SCRUB", "FINANCIAL_MARKET_INDEX", "FINANCIAL_PII_CLEARING", "FINDERPEOPLE", "FINDPEOPLEVE",
    "FIND_CELL_NUMBER", "FIND_OWNER_SEARCH", "FIND_PERSON_ONLINE", "FIND_PHONE_OWNER", "FIRST_DATA", "FLOC_DATA_HUB",
    "FREEPEOPLEDIRECTORY", "FUSION_IDENTITY", "GALE_GROUP", "GEO_DATA_SOLUTIONS", "GLADKNOW",
    "GLOBAL_DATA_EXCHANGE", "GLOBAL_IDENTITY_REGISTRY", "GLOBAL_PEOPLE_INDEX",
    ...
    "LEAD411", "LEGAL_DOCUMENT_SERVICER",
    ...
    "QUANTCAST_IDENTITY", "RADARIS", "RADARIS_SEARCH", "REAL_ESTATE_SCRUB", "RECORDID_USA",
    "RECORD_FINDER_ONLINE", "REMOVALS_SYS",
    ...
    "SEARCHBUG", "SEARCHIDENTITY_NET", "SEARCHPEOPLEFREE",
    "SEARCH_PEOPLE_DIRECT", "SEARCH_PEOPLE_PRO", "SECURE_DATA_NODES", "SEGMENT_IDENTITY", "SEMAPHORE_DATA",
    "SHARETHROUGH_DATA", "SIGNALHIRE", "SIGNAL_IDENTITY",
    ...
    "TRUTH_FINDER_PRO", "UNLIMITED_RECORDS", "UPLEAD", "USSEARCH", "USSPHONE",
    "US_DATA_CORPORATION",
    ...
    "VERISK_ANALYTICS", "VOTER_INDEX", "VOTER_VAULT", "VOTE_RECORDS", "WEB_DATA_SCRUB",
    "WHITEPAGES", "WHITEPAGES_PREMIUM", "WHO_CALLS_ME",
    "WILLIAMS_DATA", "WORLD_CHECK", "XANDER_IDENTITY", "YELLOW_PAGES_DIRECT", "YIELDMO_DATA",
    "ZEOTAP_IDENTITY", "ZOOMINFO"
]
