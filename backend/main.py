...
BROKERS = [
    ...
    "AUDIENS_DATA", "AUTOMATED_INFO", "BACKGROUNDALERT", "BACKGROUNDCHECK_PLUS", "BACKGROUND_CHECKER", "BACKGROUND_CHECK_ONLINE",
    ...
    "CIVIL_RECORDS_SEARCH", "CLARITAS", "CLEAR", "CLEARBIT", "CLEAR_SEARCH", "COCONUT",
    ...
    "DISCOVER_ORGANIZATION", "DNB_BUSINESS", "DONNELLEY_MARKETING", "DRAWBRIDGE_IDENTITY", "DSG_CONSUMER", "DST_SYSTEMS",
    "DUN_AND_BRADSTREET", "EARNED_MEDIA", "EASYPEOPLESEARCH", "EDFX_DATA", "ENGINE_MEDIA", "ENTERPRISE_DATA_HUB",
    "EQUIFAX", "EQUIFAX_WORKFORCE", "EVERYMARKET", "EXACT_DATA", "EXECUCOMP", "EXECUTIVE_INFO_SERVICES",
    "EXECUTIVE_SEARCH", "EXPERIAN", "EXPERIAN_MARKETING", "EYEOTA_AUDIENCE", "EYOTA_DATA", "Epsilon_DATA",
    "FAMILY_TREE_NOW", "FASTPEOPLESEARCH", "FAST_BACKGROUND_CHECK", "FINANCIAL_DATA_SCRUB", "FINANCIAL_MARKET_INDEX", "FINANCIAL_PII_CLEARING",
    "FINDERPEOPLE", "FINDPEOPLEVE", "FIND_CELL_NUMBER", "FIND_OWNER_SEARCH", "FIND_PERSON_ONLINE", "FIND_PHONE_OWNER",
    "FIRST_DATA", "FLOC_DATA_HUB", "FREEPEOPLEDIRECTORY", "FUSION_IDENTITY", "GALE_GROUP", "GEO_DATA_SOLUTIONS",
    "GLADKNOW", "GLOBAL_DATA_EXCHANGE", "GLOBAL_IDENTITY_REGISTRY", "GLOBAL_PEOPLE_INDEX", "HARTEHANKS", "HUNTERIO",
    "IDENTITYSCOOP", "IDENTITY_ALLIANCE", "IDENTITY_GUARDIAN_CORP", "IDTRUE", "IMPROVE_DIGITAL", "INDEX_EXCHANGE",
    "INFOGROUP", "INFOLINX", "INFORMED_DATA", "INFOTORUS", "INFOTRACK", "INFOUSE",
    "INFOVERIFIED", "INFO_TRACER", "INMOBI_IDENTITY", "INNOVIS", "INNOVIS_RISK", "INSIGHT_TARGETING",
    "INSTANTCHECKMATE", "INTEGRATED_DATA", "INTELIUS", "INTELLIGENT_MARKETING", "INTELLIUS", "INTEL_BROKER_GROUP",
    "INTERACTIVE_RECORDS", "IPERCEPTIONS", "IRIS_DATA", "KANTAR_MEDIA", "KASPR", "KENSHO_DATA",
    "KESTREL_DATA", "KNOWLEDGE_BASE", "KRED", "LCI", "LEAD411", "LEGAL_DOCUMENT_SERVICER",
    ...
    "PIPL", "PIPLSEARCH", "PIPL_IDENTITY", "PLACEMENT_MEDIA", "POLITICAL_DATA_INC", "POWER_RECORDS",
    "PREMIER_DATA", "PRIME_TARGETING", "PRIVACYSCAN_DIRECT", "PRIVACY_GUARD", "PRIVACY_GUARD_PRO", "PRIVACY_SUBPOENA_EXCHANGE",
    "PRIVATEEYE", "PRIVATE_RECORDS_NOW", "PROPEOPLE", "PROPERTY_REGISTRY_DIRECT", "PROSPECT", "PROSPECT_INFO",
    "PUBLICRECORDS_NOW", "PUBLIC_COURT_AGGREGATOR", "PUBLIC_DATA_ONLINE", "PUBLIC_INFO_EXCHANGE", "PUBLIC_RECORDS_DIRECT", "PUBLIC_RECORDS_SEARCH",
    "PUBMATIC_IDENTITY", "QUANTCAST", "QUANTCAST_IDENTITY", "RADARIS", "RADARIS_SEARCH", "REAL_ESTATE_SCRUB",
    "RECORDID_USA", "RECORD_CHECK_PRO", "RECORD_FINDER_ONLINE", "REMOVALS_SYS", "REPRESENTATIVE_DATA", "REVEAL",
    "REVEALER", "REVEALNAME", "REVENUE_DATA", "REVERSELINK", "REVERSELOOKUP_ONLINE", "REVERSEPHONE",
    "REVERSE_CELL_LOOKUP", "REVERSE_DIRECTORY_PRO", "REVERSE_PHONE_EXPRESS", "RISK_DATA_SOLUTIONS", "ROCKETREACH", "RUBICON_IDENTITY",
    "SALESINTEL", "SALES_INTELLIGENCE", "SCAN_DATA", "SEAMLESSAI", "SEARCHBUG", "SEARCHIDENTITY_NET",
    "SEARCHPEOPLEFREE", "SEARCH_PEOPLE_DIRECT", "SEARCH_PEOPLE_PRO", "SECURE_DATA_NODES", "SEGMENT_IDENTITY", "SEMAPHORE_DATA",
    ...
    "VERISK_ANALYTICS", "VOTER_INDEX", "VOTER_VAULT", "VOTE_RECORDS", "WEB_DATA_SCRUB", "WHITEPAGES",
    "WHITEPAGES_PREMIUM", "WHO_CALLS_ME", "WILLIAMS_DATA", "WORLD_CHECK", "XANDER_IDENTITY", "YELLOW_PAGES_DIRECT",
    "YIELDMO_DATA", "ZABASEARCH", "ZABA_SEARCH_PRO", "ZEOTAP_IDENTITY", "ZOOMINFO"
]
...
MANUAL_BROKERS = [
    "MERKLE_MARKETING", "METRICS_DIRECT", "MICROBUILD", "MINDSHARE", "MOBILE_DATA_SCRUB", "NATIONALRECORDS_OFFICE",
    "NATIONAL_CELLULAR", "NATIONAL_CELLULAR_INDEX", "NATIONAL_CHANGE_ADDRESS", "NATIONAL_CREDIT", "NATIONAL_TENANT", "NATIONWIDEPEOPLE",
    "NATIONWIDE_RECORDS", "NATIVE_TOUCH_DATA", "NEUSTAR", "NEUSTAR_ADTECH", "NEUSTAR_IDENTITY", "NEXTMARK",
    "NEXTMARK_DIRECT", "NEXXUS", "NUMBER_SCRUBBER_PRO", "NUWBER", "OFFICE_DATA", "OMNICOM_DATA",
    "ONE_TRUST_PRIVACY", "OPENX_AUDIENCE", "OPENX_IDENTITY", "OPTIMIZE_DATA", "ORACLE_DATALOGIX", "ORACLE_IDENTITY",
    "OWNER_CHECK", "PALANTIR_DATA", "PATH_ANALYTICS", "PEOPLEBYNAME", "PEOPLEDIR", "PEOPLEFIND",
    "PEOPLEFINDERS", "PEOPLEFINDS_NET", "PEOPLELOOKER", "PEOPLELOOKUP", "PEOPLEMAP", "PEOPLESEARCHNOW",
    "PEOPLESEARCH_EXPRESS", "PEOPLESEARCH_PRO", "PEOPLESKIP", "PEOPLETRACE", "PEOPLE_SEARCH_EXPRESS", "PEOPLE_SEARCH_NOW",
    "PERFECT_LEADS", "PHONEDETECTIVE", "PHONE_DETECTIVE_PRO", "PHONE_LOOKUP_DIRECT", "PIPL", "PIPLSEARCH",
    ...
    "RECORD_FINDER_ONLINE", "REMOVALS_SYS", "REPRESENTATIVE_DATA", "REVEAL", "REVEALER", "REVEALNAME",
    "REVENUE_DATA", "REVERSELINK", "REVERSELOOKUP_ONLINE", "REVERSEPHONE", "REVERSE_CELL_LOOKUP", "REVERSE_DIRECTORY_PRO",
    "REVERSE_PHONE_EXPRESS", "RISK_DATA_SOLUTIONS", "ROCKETREACH", "RUBICON_IDENTITY", "SALESINTEL", "SALES_INTELLIGENCE",
    "SCAN_DATA", "SEAMLESSAI", "SEARCHBUG", "SEARCHIDENTITY_NET", "SEARCHPEOPLEFREE", "SEARCH_PEOPLE_DIRECT",
    "SEARCH_PEOPLE_PRO", "SECURE_DATA_NODES", "SEGMENT_IDENTITY", "SEMAPHORE_DATA", "SHARETHROUGH_DATA", "SHIELDSEARCH",
    "SHIELDTRACE_USA", "SHIELD_DATA_SCRUB", "SIGNALHIRE", "SIGNAL_IDENTITY", "SMARTBACKGROUNDCHECKS", "SMART_DATA",
    "SMART_LOOKUP", "SNEAKPEEQ", "SOLOMON_DATA", "SOURCE_DATA", "SPOKEO", "SPOKEO_ADVANCED",
    "SPOKE_ANALYTICS", "SPYDIALER", "STATISTICALACCOUNTS", "TAPAD_DEVICE_GRAPH", "TAPHAVE", "TARGET_DATA",
    "TELECOM_DATA_NETWORK", "TELECOM_RECORDS_DIRECT", "TELEPHONE_DIRECTORY_USA", "TENANT_BACKGROUND", "THATSTHEM", "THETA_DATA",
    "TOTAL_INFO", "TRACK_PEOPLE_NOW", "TRADE_DATA", "TRANSUNION", "TRANSUNION_WORKFORCE", "TRIPLELIFT_IDENTITY",
    "TRUEPEOPLESEARCH", "TRUE_IDENTITY_SEARCH", "TRUSTEDPEOPLE", "TRUTHFINDER", "TRUTH_FINDER_PRO", "UNLIMITED_RECORDS",
    "UPLEAD", "USAINFO", "USSEARCH", "USSPHONE", "US_CELLULAR_LOOKUP", "US_DATA_CORPORATION",
    "US_DIRECTORY_ONLINE", "US_INFO_SEARCH", "US_RECORDS_DIRECT", "US_SEARCH_PRO", "UTILITY_RECORDS_SCRUB", "VALID_DATA",
    "VALLEYROOT", "VALPAK_DATA", "VALUE_MARKETING", "VECTOR_DATA", "VERIFIEDPEOPLE", "VERIFIED_BACKGROUND",
    "VERIFIED_CREDIT_SCRUB", "VERIFIED_INFO", "VERIFIED_RECORDS", "VERIPAGES", "VERISK_ANALYTICS", "VOTER_INDEX",
    "VOTER_VAULT", "VOTE_RECORDS", "WEB_DATA_SCRUB", "WHITEPAGES", "WHITEPAGES_PREMIUM", "WHO_CALLS_ME",
