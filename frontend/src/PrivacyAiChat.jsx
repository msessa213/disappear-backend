    ...
    try {
      ...
      if (response.ok) {
        ...
        setMessages(prev => [...prev, { 
          sender: 'ai', 
          text: "I am having trouble reaching the command server. Here is a quick overview:\n\n• **Elite Privacy Plan**: $19.99/month ($229.88/yr annual with $10 flat savings)\n• **Included**: 400+ broker data scrubs, 5 relay slots, human analyst audits, and emergency burn." 
        }]);
      }
    } catch (err) {
      setMessages(prev => [...prev, { 
        sender: 'ai', 
        text: "Our privacy shield is active! Our **Elite Plan is $19.99/mo** (or **$229.88/yr annual with $10 flat savings**). It includes continuous 400+ data broker scrubs, 5 burner email/phone relays, and emergency wipe." 
      }]);
    } finally {
      setIsTyping(false);
    }
